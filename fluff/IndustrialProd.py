...
# Fetch the industrial production index data from FRED
...
plt.plot(industrial_production, label='Industrial Production Index', color='blue')
...
plt.title('Industrial Production Index Over the Last 30 Years')
plt.xlabel('Year')
plt.ylabel('Index')
plt.legend()
plt.grid(True)
